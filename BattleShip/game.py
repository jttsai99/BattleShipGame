...
#Actually Playing the Game
    def play(self)-> None:
        while True:
            ...
            self.shotstatus = self.get_cur_player().check_shot_hit_miss(self.get_other_player())
            self.get_cur_player().add_to_scanningboard(self.get_other_player(),self.shotstatus)
            self.change_turn()
